...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Care Plus Auto Repairing. Call us, email us, or visit our workshop at Dubai, United Arab Emirates. Professional car maintenance services.",
};
